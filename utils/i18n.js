  ...
  en: {
    translation: {
      ...
      upgradePremium: {
        ...
        subscriptionActive:
          "Your subscription is active. Enjoy all the premium benefits!",
  ...
  ar: {
    translation: {
      ...
      upgradePremium: {
        ...
        getPremiumBenefitsTitle: "احصل على مزايا الاشتراك المميز",
        unlockPremiumFeatures: "افتح الميزات المميزة",
        loadingSubscriptions: "جاري تحميل خطط الاشتراك...",
        upgradeToPremiumTitle: "الترقية إلى الاشتراك المميز",
        fetchProductsError: "فشل تحميل خطط الاشتراك: {{message}}",
        unlockPremiumBenefits: "افتح مزايا الاشتراك المميز:",
        unlimitedReceipts: "تحميل فواتير غير محدود",
        ...
        advancedSpendingAnalytics: "تحليلات متقدمة للإنفاق",
        priorityCustomerSupport: "دعم العملاء ذو الأولوية",
        ...
        termsDisclaimer:
          "بالاشتراك، أنت توافق على شروط الخدمة وسياسة الخصوصية الخاصة بنا. تتم إدارة الاشتراكات من خلال إعدادات متجر التطبيقات بجهازك.",
        purchaseSuccess: "تم تفعيل اشتراكك المميز بنجاح!",
        purchaseFailedGeneric: "فشل الشراء. يرجى المحاولة مرة أخرى.",
        purchaseNotAllowed: "الشراء غير مسموح به على هذا الجهاز أو الحساب.",
        paymentPending:
        ...
        restoreSuccess: "تم استعادة مشترياتك السابقة بنجاح!",
        noActivePurchasesFound: "لم يتم العثور على مشتريات نشطة لحسابك.",
        restoreFailedGeneric: "فشل استعادة المشتريات. يرجى المحاولة مرة أخرى.",
        networkError: "خطأ في الشبكة. يرجى التحقق من اتصالك بالإنترنت.",
        updateStatusError: "فشل في تحديث حالة الاشتراك المميز: {{message}}",
        loadingDetails: "جاري تحميل تفاصيل الاشتراك المميز...",
        goPremiumTitle: "انتقل إلى المميز!",
        exportData: "تصدير البيانات إلى Excel/PDF",
        noAds: "لا توجد إعلانات (إن وجدت)",
        ...
        alreadyPremiumTitle: "أنت مشترك بالفعل",
        ...
        serviceDescription:
          "افتح ميزات غير محدودة للفواتير والميزانيات المخصصة والتحليلات المتقدمة للإنفاق.",
        alreadySubscribed: "أنت مشترك مميز بالفعل.",
        subscriptionActive: "اشتراكك نشط. استمتع بجميع المزايا المميزة!",
        youArePremium: "أنت عضو مميز",
        manageSubscription: "إدارة الاشتراك",
        nextRenewal: "التجديد القادم",
        yourPlan: "خطتك",
        copyDebugInfo: "نسخ المعلومات",
        subscriptionExpires: "ينتهي الاشتراك في ",
        resubscribe: "إعادة الاشتراك",
        cancellationInitiatedTitle: "تم بدء الإلغاء",
        cancellationInitiatedMessage:
          "تمت إعادة توجيهك إلى المتجر لإدارة اشتراكك. يرجى ملاحظة أن تحديث حالة الإلغاء في التطبيق قد يستغرق بضع دقائق.",
        bestValue: "أفضل قيمة",
        pricePerMonthYearly: "{{price}} / شهر، يتم الفوترة سنويًا",
        featuresListTitle: "ما ستحصل عليه:",
        notPremiumYet: "أنت لست عضوًا مميزًا بعد.",
        benefitsDescription:
          "استمتع بتجربة مالية أكثر ثراءً مع ميزاتنا المميزة.",
      },
      editProfile: {
