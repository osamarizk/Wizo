  ...
  ar: {
    translation: {
      ...
      upgradePremium: {
        ...
        unlockPremiumBenefits: "افتح الميزات المميزة:",
        ...
        purchaseNotAllowed: "المشتريات غير مسموح بها على هذا الجهاز أو الحساب.",
        paymentPending:
          "دفعتك معلقة. سيتم تفعيل وصولك المميز بمجرد تأكيد الدفع.",
        productNotAvailable: "المنتج المحدد غير متاح للشراء.",
        purchaseInvalid: "هذه عملية شراء غير صالحة للمنتج المحدد.",
        cannotFindProduct:
