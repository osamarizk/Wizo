...
If yes, **PRIORITY: Extract information quickly and efficiently.** respond with:
{
  ...
  "data": {
    ...
    "datetime": "...", // **CRITICAL: Convert to ISO 8601 (YYYY-MM-DDTHH:mm:ss.sssZ).** For two-digit years (e.g., '25), assume 20XX (e.g., 2025). **HYPER-IMPORTANT: If the date is in 'DD mm'YY' format (e.g., '2 Jul'25'), the first number (e.g., '2') is the DAY, and the 'YY' (e.g., '25') is the YEAR.** Always infer and include time (HH:mm:ss) and timezone (Z for UTC/Zulu time if not explicitly stated, or infer offset). If only date is present, set time to 00:00:00. Prioritize receipt's year. For DD/MM/YYYY vs MM/DD/YYYY, assume DD/MM/YYYY (e.g., 03/06/2025 is June 3rd).
    "location": {
