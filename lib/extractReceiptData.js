...
"datetime": "...", // **CRITICAL: Convert to ISO 8601 (YYYY-MM-DDTHH:mm:ss.sssZ).** For two-digit years (e.g., '25), assume 20XX (e.g., 2025).
// --- HYPER-CRITICAL INSTRUCTION FOR DAY EXTRACTION ---
// When the date is in 'D MMM'YY' or 'DD MMM'YY' format (e.g., '7 Jul'25'):
// The number (e.g., '7') that APPEARS IMMEDIATELY BEFORE the three-letter month abbreviation (e.g., 'Jul')
// MUST BE THE DAY OF THE MONTH.
// DO NOT infer a different day (like '25') if a clear number is present before the month abbreviation.
// Example: If you see '7 Jul '25', the DAY IS 7.
// --- END HYPER-CRITICAL INSTRUCTION ---
Always infer and include time (HH:mm:ss) and timezone (Z for UTC/Zulu time if not explicitly stated, or infer offset). If only date is present, set time to 00:00:00. Prioritize receipt's year. For DD/MM/YYYY vs MM/DD/YYYY, assume DD/MM/YYYY (e.g., 03/06/2025 is June 3rd).
    "location": {
    ...
    "serviceCharge": // Read the EXACT 'Service Charge'.
