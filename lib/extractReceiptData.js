...
If yes, respond with:
{
  ...
  "data": {
    ...
    "discount": ..., // The total monetary value of all reductions, promotions, or coupons applied to the entire purchase. Look for terms like "discount", "disc", "promo", "reduction", "savings", "coupon". If no discount is found, return 0.
    "vat": ...,      // The explicit Value Added Tax (VAT) amount shown on the receipt. If VAT is included in the item prices and not broken out separately, or if no VAT is shown, return 0.
   ...
   "loyaltyPoints":"...", // the number of loyalty points earned or redeemed during the transaction. If not found, return null.
   "loyaltyProgram":"...", // the name of the loyalty program associated with the trannsaction. If not found return null.
   "notes":"..." // Any additional notes or comments from the receipt. If not found, return null.
