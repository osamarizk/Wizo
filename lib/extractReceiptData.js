...
If yes, respond with:
{
  ...
  "data": {
    ...
    "datetime": "...", // Format as ISO 8601 string (e.g., "YYYY-MM-DDTHH:mm:ss.sssZ"). Crucially, if the year is given in a two-digit format (e.g., '25), assume the current century (20XX). For example, '25 should be 2025, not 1925 or 2023. Prioritize the year indicated on the receipt.
    "location": {
      ...
      generationConfig: {
        ...
        responseSchema: {
          ...
          properties: {
            ...
            data: {
              type: "OBJECT",
              nullable: true, // Allow null if isReceipt is false
              properties: {
                merchant: { type: "STRING", nullable: true },
                datetime: { type: "STRING" }, // ISO 8601 string
                location: {
                  type: "OBJECT",
                  nullable: true,
                  properties: {
                ...
                cashierId: { type: "STRING", nullable: true },
                storeBranchId: { type: "STRING", nullable: true },
                loyaltyPoints: { type: "NUMBER" },
                loyaltyProgram: { type: "STRING", nullable: true },
