...
If yes, respond with:
{
  ...
  "data": {
    ...
    "datetime": "...", // Format as ISO 8601 string (e.g., "YYYY-MM-DDTHH:mm:ss.sssZ").
                      // 1. Crucially, if the year is given in a two-digit format (e.g., '25), assume the current century (20XX). For example, '25 should be 2025, not 1925 or 2023. Prioritize the year indicated on the receipt.
                      // 2. IMPORTANT: For ambiguous numeric dates like "DD/MM/YYYY" vs "MM/DD/YYYY" (e.g., 03/06/2025), assume the format is DAY/MONTH/YEAR. For example, 03/06/2025 should be June 3rd, 2025, not March 6th, 2025. Prioritize DD/MM/YYYY format for ambiguous numeric dates.
    "location": {
